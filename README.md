...
A static [Astro](https://astro.build) site hosted on [Azure Static Web Apps](https://learn.microsoft.com/azure/static-web-apps/), deployed from `master` via GitHub Actions. Infrastructure (Terraform) is in [iac-cloud-architecture](https://github.com/Cloud-Architecture-UK/iac-cloud-architecture). The live site is currently behind a "coming soon" gate (`public/staticwebapp.config.json`) while it's built out.
